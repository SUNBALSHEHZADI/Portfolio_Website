...
export const HeroSection = () => {
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroBg} alt="AI Neural Network Background" className="w-full h-full object-cover opacity-30 dark:opacity-50" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 relative inline-block">
            <div className="w-40 h-40 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-primary to-accent p-1 mx-auto">
              <img src={profilePhoto} alt="Sunbal Shehzadi - AI & ML Engineer" className="w-full h-full rounded-full object-cover" />
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button size="lg" className="bg-gradient-to-r from-primary to-accent hover:opacity-90 text-primary-foreground px-8 py-6 text-lg" asChild>
